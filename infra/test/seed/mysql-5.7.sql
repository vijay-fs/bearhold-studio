-- Reference "shop" schema for MySQL 5.7. Kept dialect-strict:
--   - No CHECK constraints (5.7 accepts them but silently ignores)
--   - No functional / expression indexes (added in 8.0.13)
--   - No JSON type used in defaults (5.7 rejects JSON DEFAULTs entirely)
--   - AUTO_INCREMENT + BIGINT UNSIGNED, ENUM stored as MySQL ENUM
